...
\subsection{Solutions, 2024-12-xx}
...
\subsection{Exam, 2025-12-29}

\begin{enumerate}
\item {[10]} Consider the Black and Scholes model. 
The risk-free interest rate is equal to $r$. 
The volatility of the share is equal to $\sigma$. 
You have an option that pays you $X_T = \min\{1, \max\{\ln S_T, 0\}\}$ at fixed time moment $T$.

Find an arbitrage free price $X_0$ of the option.
...
$A_t = \int_0^t u \, dW_u, \quad B_t = \int_0^t u W_u^4 \, dW_u, \quad C_t = \int_0^t u W_u^2 \, du$.
\begin{enumerate}
...
\subsection{Solutions, 2025-12-29}
